...
// 📈 Récupération des statistiques de tests
...
<body class="bg-gray-900 text-white min-h-screen flex flex-col items-center justify-start px-6 py-10 font-sans">
  <div class="w-full max-w-6xl space-y-10">
    ...
    <!-- 🧾 Header (Hauteur réduite pour meilleure lisibilité) -->
  ...
  <!-- 📊 Script pour le diagramme Chart.js -->
  <script>
...
// 💾 Écrit le fichier HTML généré dans ./public/index.html
